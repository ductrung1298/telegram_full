...
$url='http://localhost:3000/telegram/get_friend?id='.$id;
    ...
    if ($httpcode==500)
        ...
        if (isset($_GET['idgroup']))
            $url2='http://localhost:3000/telegram/get_user_in_group_chat?id='.$id.'&chat_id='.$_GET['idgroup'];
        else $url2='http://localhost:3000/telegram/get_user_in_group_chat?id='.$id.'&channel_id='.$_GET['idchannel'].'&access_hash='.$_GET['access_hash'];
